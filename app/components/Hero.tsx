...
const Hero = () => {
  return (
    <section id="home" className="min-h-svh w-full max-w-6xl mx-auto">
      <div className="flex flex-col md:flex-row justify-center sm:justify-between items-center flex-wrap p-3 gap-6">
